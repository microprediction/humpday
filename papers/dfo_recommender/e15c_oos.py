"""E15b — Out-of-sample validation of the signed-composition winner.
...
OUT = "runs/e15c_oos.json"
NEW_NAME = "caricature_abl"
NEW_CODE = "runs/e15_code/goodPSNM_caricature_d1_ablated.py"
