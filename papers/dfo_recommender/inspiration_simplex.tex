...
pairwise (54\%, $p = 0.04$; 58\% at the largest budget). The margin is
discounted twice, by post-hoc selection among the raced twins and by the
held-out set's reuse, so succession is decided on fresh instances rather
than claimed here. Exploring outside the simplex keeps producing strong
