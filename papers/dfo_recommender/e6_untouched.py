...
UNTOUCHED = [
    "battery_dispatch_72d", "diet_problem", "economic_dispatch_valve",
    "ev_fleet_charging", "fir_filter_design", "free_kick",
    "groundwater_remediation", "heat_exchanger_network", "index_tracking",
    "inventory_policy", "lennard_jones_cluster_90d", "microgrid_dispatch",
    "multi_exponential_fit", "pool", "protein_fold_toy", "radiation_therapy",
    "reservoir_release", "revenue_pricing", "robot_arm", "rocket_landing",
    "rocket_landing_24d", "rocket_landing_36d", "rocket_landing_48d",
    "rocket_landing_60d", "satellite_phasing", "traffic_signal",
    "vaccine_allocation", "water_distribution", "wind_farm_40d",
]
