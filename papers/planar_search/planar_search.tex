...
Gaussian process --- by the value, not the information, of the acquired
point --- beats a line search on three quarters of high-dimensional
...
2012; Wang and Jegelka 2017), which favors the most uncertain point
...
--- and the only exact object it uses is the dimension reduction
itself.
