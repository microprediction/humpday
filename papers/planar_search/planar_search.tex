...
One adjustment is necessary. The theory paper rewards the terminal
recommendation, whereas an optimizer keeps the best evaluated point. The
geometric reduction survives that change exactly --- it is a fact about
the posterior, not the objective --- but the opening step-size constants
must be re-derived for the expected-improvement objective. We leave that
derivation and a full planar-search implementation to the experiments
