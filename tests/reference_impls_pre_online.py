...
class FrozenDifferentialEvolution(BaseOptimizer):
    ...
    def optimize(self):
        ...
        while True:
            ...
            # Twin of the live DifferentialEvolution, which gained this in the budget-forfeit fix:
            # the polish converges in eight to eighteen evaluations and the rest of the reserve
...
class FrozenBayesianOpt(BaseOptimizer):
    ...
    # Mirrors BayesianOpt._GP_MAX_OBSERVATIONS / _conditioning_set (#330): the kernel solve is
    # cubic in the number of observations and runs once per iteration, so an uncapped set made
    # the whole run quartic in the budget.
